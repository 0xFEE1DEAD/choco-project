...
class EnsureQueueListenerIsRunning extends Command
{
    ...
    {
        if ( ! Storage::disk('local')->exists('queue.pid')) {
            return false;
        }

        return file_get_contents(Storage::disk('local')->path('queue.pid'));
    }
    ...
    {
        file_put_contents(Storage::disk('local')->path('queue.pid'), $pid);
    }
